...
// Version: 20260310-2230
// =============================================================================

const CACHE_NAME = 'immo-lux-v20260310-2230';
...
self.addEventListener('fetch', event => {
  ...
  // version.js : JAMAIS mis en cache — doit toujours être le plus récent
  // (contient la version du build auto-incrémentée par dashboard_generator.py)
  if (url.pathname.endsWith('version.js')) {
    event.respondWith(fetch(request));
    return;
  }

  // Stratégie pour données JSON/JS dynamiques: network-first (toujours à jour)
