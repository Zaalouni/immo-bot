...
(function () {
    ...
    function showVersion() {
        ...
        badge.style.cssText = [
            ...
            'white-space:nowrap',  // pas de coupure de "v2.7.42" sur plusieurs lignes
            'overflow:visible',    // texte toujours visible en entier
            'max-width:none'       // pas de troncature possible
        ].join(';');
